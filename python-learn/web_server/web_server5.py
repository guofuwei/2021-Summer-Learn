...
class WSGIServer(object):
    def __init__(self,port,app,html_path):
...
def main():
    ...
    with open('./web_server/web_server.config') as f:
        conf_content=eval(f.read())
    ...
    wsgiserver=WSGIServer(port,app,conf_content['html_path'])
